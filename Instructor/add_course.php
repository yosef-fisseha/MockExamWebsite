...
if(isset($_POST['course'])){
    ...
    $sql = "INSERT INTO `course`(`courseID`, `coursename`, `dep_ID`) VALUES ('','$coursename','$depID')";
            ...
            <nav id="sidebarMenu" class="">
                ...
                <main class="main-wrapper col-md-9 ms-sm-auto py-4 col-lg-10 px-md-4 border-start">
                    <div class="title-group mb-3">
                        <h1 class="h2 mb-0" style="position:relative;">Add New Course</h1>
                    </div>
                        ...
                        <div class="col-lg-10 col-12">
                            ...
                            <form action="" class="custom-form profile-form" method="post">
                                ...
                                <label for="course">Course</label><br>
                                    ...
                                    <button type="submit" name="submit" class="btn btn-success">ADD</button><br>
                                </form>
                            </div>
                        </div>
                    </div>
