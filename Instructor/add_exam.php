...
if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['exam_name']) && isset($_POST['number_of_ques'])){
    
    $exam_name = $_POST['exam_name'];
    $num_ques = $_POST['number_of_ques'];

    $query= mysqli_query($connect,"INSERT INTO `exam_category`(`level_ID`, `exam_level`, `exam_time`, `department`) VALUES ('','$exam_name','$num_ques','$department_name')");
            ...
            <nav id="sidebarMenu" class="">
                    <div class="position-fixed py-4 px-3 sidebar-sticky ">
                        <ul class="nav flex-column h-100">
                            ...
                            <h7>Manage Exams</h7>
                            <li class="nav-item">
                                <a class="nav-link active" href="add_exam.php">
                                    <i class="bi bi-plus-circle"></i>
                                    Add exam
                                </a>
                ...
                <main class="main-wrapper col-md-9 ms-sm-auto py-4 col-lg-10 px-md-4 border-start">
                    <div class="title-group mb-3">
                        <h1 class="h2 mb-0" style="position:relative;">Create New Exam</h1>
                    </div>
                        ...
                        <div class="col-lg-10 col-12">
                            <div class="custom-block bg-white">
                                ...
                                <label for="exam_name">Exam Name</label><br>
                                    ...
                                    <input type="number" name="number_of_ques" id="number_of_ques" required  class="form-control"/>
