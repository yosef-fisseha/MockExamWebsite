            ...
            <nav id="sidebarMenu" class="">
                ...
                <main class="main-wrapper col-md-9 ms-sm-auto py-4 col-lg-10 px-md-4 border-start">
                    <div class="title-group mb-3">
                        <h1 class="h2 mb-0" style="position:relative;">Manage Course</h1>
                    </div>

                    <?php 
                        $sql = "SELECT * FROM `course`INNER JOIN department on course.dep_ID = department.dep_ID WHERE course.dep_ID = $department_ID";
                        $result = mysqli_query($connect,$sql);
                        
                        ?>
                        <div class="row my-4">
                        <div class="col-lg-12 col-12">
                            <div class="custom-block bg-white" style="border-radius: 20px;">
                                <style>
                                    td{
                                        font-size: medium;
                                    }
                            ...
                            <tr class="bg-color" style="background-color: #dc3545; color: white;">
                                <td>ID</td>
                                <td>Course</td>
                                <td>Department</td>
                                <td>Options</td>
                            ...
                            ?>
                                ...
                                <td>
                                <button class="btn btn-primary "><a href="update_course.php?course=<?php echo $courseID?>&department=<?php echo $dep_ID?>" class="text-light">Edit</a></button>

                                <button class="btn btn-danger" style="margin-left: 20px;"><a href="remove_course_confirm_msg.php?course=<?php echo $courseID?>&department=<?php echo $dep_ID?>" class="text-light">Remove</a></button>
                            </td>          
                            </tr>
                                <?PHP
                                }
