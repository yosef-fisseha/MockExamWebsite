...
if(isset($_GET['course'])){
    $query = mysqli_query($connect,"SELECT * FROM course WHERE courseID = $cou_ID");
...
if(isset($_POST['course'])){
    ...
    $sql = "UPDATE `course` SET `coursename`='$coursename' WHERE courseID = $cou_ID";
    ...
    header("Location: manage_course.php?course=$cou_ID&department=$dep_ID");
}
?>
<!doctype html>
<html lang="en">
            ...
            <nav id="sidebarMenu" class="">
                ...
                <main class="main-wrapper col-md-9 ms-sm-auto py-4 col-lg-10 px-md-4 border-start">
                    <div class="title-group mb-3">
                        <h1 class="h2 mb-0" style="position:relative;">UPdating Course</h1>
                    </div>
                        ...
                        <div class="col-lg-10 col-12">
                            <div class="custom-block bg-white">
                                <form class="custom-form profile-form" action="" method="post">
                                    ...
                                    <input type="text" name="course" id="course" value="<?php echo $course ?>" required class="form-control"/>
