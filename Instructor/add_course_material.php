...
require_once("connect/connection.php");
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['courseID']) && isset($_POST['links'])){
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST" && $_FILES["material"]["error"] == UPLOAD_ERR_OK) {
            ...
            $db_name2 = "/MockExamWebsit/course materials/$selected_mtbl/$filename2";
        ...
        $sql = "INSERT INTO `$selected_mtbl`(`ID`, `material_name`, `material_path`, `note_name`, `note_path`, `videolinks`, `courseID`, `dep_ID`) VALUES ('','$filename','$db_name','$filename2','$db_name2','$links','$courseID','$dep_ID')";
        
        $query1 = mysqli_query($connect,$sql);

            if($query1){
                
                header("Location: confirmation_msg.php?success=1&for=add_curs&department=$newID");
                exit();
            }else{
            
                header("Location: confirmation_msg.php?success=0&for=add_curs&department=$newID");
                exit();
            } 
    }
?>
            ...
            <nav id="sidebarMenu" class="">
                    <div class="position-fixed py-4 px-3 sidebar-sticky ">
                        <ul class="nav flex-column h-100">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="add_course_material.php">
                                    <i class="bi bi-plus-circle"></i>
                                    Add Course Material
                                </a>
                            </li>
                ...
                <main class="main-wrapper col-md-9 ms-sm-auto py-4 col-lg-10 px-md-4 border-start">
                    <div class="title-group mb-3">
                        <h1 class="h2 mb-0" style="position:relative;">Create Course Material</h1>
                    </div>

                        <div class="row my-4">
                        <div class="col-lg-10 col-12">
                            <div class="custom-block bg-white">
                                <form action="" class="custom-form profile-form" method="post" enctype="multipart/form-data">
                                ...
                                <label for="course">Course</label>
                                    ...
                                    <input type="file"  name="material" id="material" required  class="form-control"/>
    
                                    <label for="notes" >Extra Notes</label><br>
                                    <input type="file"  name="notes" id="notes" required  class="form-control"/>
    
                                    
                                    <input type="text"  name="links" id="links" required placeholder="Video Links"  class="form-control"/>
