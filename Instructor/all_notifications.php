...
$query2 = mysqli_query($connect,"UPDATE `instructor` SET `notification_status`= 0 WHERE email = '$email'");
?>
<!doctype html>
<html lang="en">
    <head>
        ...
        <div class="container-fluid">
            ...
            <nav id="sidebarMenu" class="">
                ...
                <main class="main-wrapper col-md-9 ms-sm-auto py-4 col-lg-10 px-md-4 border-start">
                    ...
                    <div class="card">
                        <div class="card-body">
                        <h3 class="card-title" style="font-weight:bolder;">Administrator Notifications</h4><br><hr><br>
                        <?php 
                            $query = mysqli_query($connect,"SELECT * FROM admin_notification WHERE `target` = 'Instructor' ORDER BY ID DESC");
