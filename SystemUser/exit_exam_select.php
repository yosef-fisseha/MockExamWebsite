...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="exit_exam_select.php" class=" active">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Exit Exams</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <div class="cotainer">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header"><h3 style="text-align: center; color:midnightblue ; font-weight: bold; " >Exit Exams</h3></div>
                    <div class="card-body">
                          <h4><input type="button" class="btn btn-success form-control"style="margin-top: 20px; background-color:slateblue; color:white border-radius: 12px; font-size: 24px; height:70px "  value="<?php echo 2015 ?>" onclick="set_exam_type_session(this.value)"></h4>  
                            <br>
                            <?php
                            
                            $query1 = mysqli_query($connect,"SELECT * from `$dep_name questions` WHERE model_or_exam = 'exam' && exam_year = 2015");
                            $count = mysqli_num_rows($query1);
                            ?>
                            <h5>Number of Questions:<?php echo $count ?></h5>
                            <hr>

                            <h4><input type="button" class="btn btn-success form-control"style="margin-top: 20px; background-color:slateblue; color:white border-radius: 12px; font-size: 24px; height:70px "  value="<?php echo 2016 ?>" onclick="set_exam_type_session(this.value)"></h4>
                            <?php
                            
                            $query1 = mysqli_query($connect,"SELECT * from `$dep_name questions` WHERE model_or_exam = 'exam' && exam_year = 2016");
                            $count = mysqli_num_rows($query1);
                            ?>
                            <h5>Number of Questions:<?php echo $count ?></h5>
                            <hr>
  ...
  <script type="text/javascript">
    function set_exam_type_session (exam_year)
    {
        var xmlhttp=new XMLHttpRequest();
        xmlhttp.onreadystatechange=function () {
            if (xmlhttp.readyState== 4 && xmlhttp.status == 200) {
                window.location = "exit_exams/exit_exams.php";
            }
        };
        xmlhttp.open("GET", "exit_exams/set_exam_type_session.php?exam_year="+exam_year, true);
        xmlhttp.send(null);
    }
</script>
