  ...
  <main id="main" class="main">
    ...
    <div class="cotainer">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header"><h3 style="text-align: center; color:midnightblue ; font-weight: bold;">Exam Category</h3></div>
                    <div class="card-body">
                    <?php 

                        $query = mysqli_query($connect,"SELECT * from exam_category WHERE department = 'all' OR department = '$dep_name'");
                        while($row = mysqli_fetch_assoc($query)){
                          ...
                          <div class="card">
                          <div class="card-body">
                            <h5 class="card-title" style="font-size: larger; font-weight: bolder; ">Exam Category:  <?php echo $row['exam_level'] ?></h5>

                            <button class="btn btn-primary form-control" style="margin-top: 20px; background-color:slateblue; color:white border-radius: 12px; font-size: 24px; height:70px "><a href="exam_instruction.php?level_ID=<?php echo $level_ID ?>" class="text-light"><?php echo $row['exam_level'] ?></a></button>
                            <br>
                            <?php
                            $lvl_ID = $row['level_ID'];
                            $query1 = mysqli_query($connect,"select * from `$dep_name questions` WHERE level_ID = $lvl_ID");
                            $count = mysqli_num_rows($query1);
                            ?>
                            <br>
                            <h5>Questions:<?php echo $count ?></h5>
