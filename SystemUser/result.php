...
$lvl_ID = $_SESSION["exam_category"];

/*$query2 = mysqli_query($connect,"SELECT `exam_level` FROM `exam_category` WHERE level_ID  = $lvl_ID ");
$row2 = mysqli_fetch_assoc($query2);
$exam_level = $row2['exam_level'];
*/
?>
<!DOCTYPE html>
<html lang="en">
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="all_results.php">
    ...
    <div class="maincontent">
        ...
        if(isset($_SESSION["answer"]))
        {
            for($i=0;$i<$que_num_size;$i++){
                $answer="";
                $query=mysqli_query($connect,"SELECT * FROM `$que_tbl_name` where `level_ID` = $_SESSION[exam_category] && questionID = $que_num[$i]");
        ...
        <?php
        $query1=mysqli_query($connect,"SELECT * FROM `$que_tbl_name` where `level_ID` = $_SESSION[exam_category]");
        ...
        <input type="button" class="btn btn-success" value="GO Back to Home" onclick="location.href = 'home.php';">
        <?php
        echo "</center>";
        ?>
        </div>
     ...
     <?php 
     $cat_sql = mysqli_query($connect,"SELECT * FROM exam_category WHERE level_ID = $lvl_ID");
     $row2 = mysqli_fetch_assoc($cat_sql);
     $exam_level = $row2['exam_level'];
     
     if(isset($_SESSION["exam_start"]))
     {
        mysqli_query($connect,"INSERT INTO `result`(`ID`, `user_name`, `dep_ID`, `category`, `exam_level`, `total_questions`, `correct_answer`, `wrong_answer`, `exam_time`) VALUES ('','$username','$dep_ID','mock exam','$exam_level','$count','$correct','$wrong','$date')");
     }
...
if(isset($_SESSION["exam_start"]))
{
    ...
    <?php
     ...
     ?>
        ...
        $query = mysqli_query($connect,"SELECT * FROM `$que_tbl_name` where `level_ID` = $_SESSION[exam_category]");
        $q_num = 1;
