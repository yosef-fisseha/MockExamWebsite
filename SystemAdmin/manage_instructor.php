...
$result = mysqli_query($connect,"SELECT * FROM instructor");
            ...
            <nav id="sidebarMenu" class="">
                    ...
                    <ul class="nav flex-column h-100">
                            ...
                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                <a class="nav-link active" href="manage_Instructor.php">
                ...
                <main class="main-wrapper col-md-9 ms-sm-auto py-4 col-lg-10 px-md-4 border-start">
                    ...
                    <h1 class="h2 mb-0 text-center" style="position:relative;">Manage Instructor</h1>
                    </div>
                            ...
                            <div class="custom-block bg-white">
                                <table class="table table-bordered text-center account-table table">
                                        ...
                                        ?>
                                            ...
                                            <td>
                                            <button class="btn btn-danger "><a href="remove_instructor_confirm.php?removeid=<?php echo $ID ?>" class="text-light">Remove</a></button>
                                        </td>          
                                        </tr>
                                            <?PHP
                                            }
